...
This release adds a customization option for the search field tooltip and it
improves the way search results are obtained for the search results
page. It removes an option related to the standard search results which only was
effective when those obtained through the plugin were presented, providing a
simpler administrative section and more consistency with the results in the live
search form.
